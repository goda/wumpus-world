...
class Environment():
    ...
    def initialize(self, grid_width: int = 4, grid_height: int = 4,
                   pit_prob: float = 0.2, allow_climb_without_gold: bool = False) -> Tuple[TEnvironment, Percept]:
        e = Environment(grid_width, grid_height, pit_prob,
    ...
    def __init__(self, grid_width: int = 4, grid_height: int = 4,
        ...
        self.pit_locations = generate_pit_locations(
    ...
    def apply_action(self, action: Action) -> Tuple[TEnvironment, Percept]:
        if self.terminated:
            return (
                self,
        ...
        if action == Action.Forward:
            ...
            is_terminated = success or (
                self.allow_climb_without_gold and at_start_location)
            return(
                self,
